...
%filename = '7A5F52750ADD07483305B0C2226A484ED74B42FD4D87B4BBBC352DCF4E8D8BB8.jpg';
filename = '6A6E132456CE9AA651058B1608B77052B4B5E10F58EDD38ABE14B0CD46891A1D.png';
%filename = '6513053600A14B930EDD7E5CDBED92EBB724676DA3F0EFDF3FD3F564743E14B4.png';
%filename = '0A681D9ADB6193D1217E62A3A0E998EBE8E5C446B5D44CB5DBAC998B5B32B6DA.jpg';
%filename = 'dino20riders.jpg';

img = imread(filename);

figA = figure;
imshow(img);
title('Original image with superimposed crop region');

% conversion to grayscale
gray = rgb2gray(img);

% edge filtering
noEdgeThreshold = 0.75;
edgeOffset = 3;
sobelX = [1 0 -1; 
          2 0 -2; 
          1 0 -1];
...
figB = figure;
imshow(G)
title('Corner filtered image with superimposed crop region');
xlabel('Sobel corners G=(G^2_x + G^2_y)^{0.5} from 3x3 kernel with threshold=0.75');
...
title('Cropped image from detected region');